...
ancestry_types = ["muggle", "squib", "half-blood", "quarter-veela", "muggleborn", "pure-blood", "half-veela"]
by_ancestries = {i: list() for i in ancestry_types}
